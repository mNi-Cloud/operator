...
# The default setup assumes Kind is pre-installed and builds/loads the Manager Docker image locally. Prometheus and CertManager are installed by default; skip with:
